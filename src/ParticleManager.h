...
public:
    ...
    inline static CCParticleSystem* twistedParticles(int numParticles) {
    ...
    inline static CCParticleSystem* diabolicalParticles(int numParticles) {
        auto dict = CCDictionary::createWithContentsOfFileThreadSafe("dragEffect.plist");
    ...
    inline static CCParticleSystem* infernalParticles1(int numParticles, bool isGrandpa) {
        auto dict = CCDictionary::createWithContentsOfFileThreadSafe("dragEffect.plist");
    ...
    inline static CCParticleSystem* infernalParticles2(int numParticles) {
        auto dict = CCDictionary::createWithContentsOfFileThreadSafe("dragEffect.plist");
